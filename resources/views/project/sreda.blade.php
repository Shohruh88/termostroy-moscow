...
<br>
    ...
    <div class="container mx-auto ">
        ...
        <div class="text-center mb-12">
            <h1 class="text-4xl font-bold text-gray-800 mb-4">ЖК Среда</h1>
            <p class="text-lg text-gray-600 max-w-4xl mx-auto">
                Современный жилой комплекс комфорт-класса с развитой инфраструктурой и удобным расположением в Москве
            </p>
        </div>
                ...
                <div class="bg-gray-50 p-6 rounded-lg">
                    <div class="grid grid-cols-1 gap-4">
                        ...
                        <div class="border-b border-gray-200 pb-4">
                            ...
                            <p class="text-gray-600">г. Москва, ул. Авиаконструктора Миля</p>
                        </div>
                        
                        <div class="border-b border-gray-200 pb-4">
                            <h3 class="text-lg font-semibold text-gray-800">Срок строительства</h3>
                            <p class="text-gray-600">2018-2023</p>
                        </div>
                ...
                <div class="space-y-6">
                    <div class="bg-white p-6 rounded-lg shadow-md">
                        ...
                        <p class="text-gray-600 leading-relaxed">
                            ЖК "Среда" представляет собой современный жилой комплекс комфорт-класса, расположенный в динамично развивающемся районе Москвы. 
                            Проект состоит из нескольких корпусов различной этажности, объединенных единой архитектурной концепцией и развитой внутренней инфраструктурой. 
                            Комплекс создан для комфортного проживания современных семей, ценящих качество и удобство.
                        </p>
                    </div>
                ...
                <div class="space-y-6">
                    <div class="bg-white p-6 rounded-lg shadow-md">
                        ...
                        <p class="text-gray-600 leading-relaxed mb-4">
                            ЖК "Среда" расположен в перспективном районе Москвы с развитой транспортной инфраструктурой. 
                            Близость к станциям метро и основным транспортным артериям обеспечивает удобную связь с центром города 
                            и другими районами столицы.
                        </p>
                        <div class="bg-gray-50 p-4 rounded">
                            <p class="text-sm text-gray-600">
                                <strong>Налоговая:</strong> ИФНС №28 по г.Москве<br>
                                <strong>Почтовый индекс:</strong> 125424
                            </p>
                        </div>
                    </div>

                    <div class="bg-white p-6 rounded-lg shadow-md">
                        <h3 class="text-xl font-semibold text-gray-800 mb-4">Инженерные системы</h3>
                        <p class="text-gray-600 leading-relaxed">
                            Жилой комплекс оснащен современными инженерными системами, обеспечивающими высокий уровень комфорта 
                            и безопасности проживания. Все системы спроектированы с учетом последних технологических стандартов 
                            и требований энергоэффективности.
                        </p>
                    </div>
                </div>
            </div>
