            ...
            <div
                ...
                <div class="mt-8 lg:mt-0 flex items-center gap-x-3 lg:ms-auto">
                    ...
                    <button onclick="changeLang('ru')"
                        class="{{ $currentLang == 'ru' ? 'bg-lime-400 text-black' : 'bg-gray-200' }} px-3 py-2 rounded">
                        RU
                    </button>
                    <button onclick="changeLang('turk')"
                        class="{{ $currentLang == 'turk' ? 'bg-lime-400 text-black' : 'bg-gray-200' }} px-3 py-2 rounded">
                        TR
                    </button>
                    <button onclick="changeLang('en')"
                        class="{{ $currentLang == 'en' ? 'bg-lime-400 text-black' : 'bg-gray-200' }} px-3 py-2 rounded">
                        EN
                    </button>
                </div>
            </div>
