...
<body class="dark:bg-neutral-900">
  ...
  <!-- Russian Flag Button -->
  <button type="button" class="w-9 h-9 rounded-full overflow-hidden hover:ring-2 ring-lime-400 transition">
...
<div class="flex items-center gap-x-1 lg:gap-x-2 ms-auto py-1 lg:ps-6 lg:order-3 lg:col-span-3">
    <!-- RU Button with Flag -->
    <button type="button" class="py-2 px-3 inline-flex items-center gap-x-2 text-sm font-medium text-nowrap rounded-xl bg-white border border-gray-200 text-black hover:bg-gray-100 focus:outline-hidden focus:bg-gray-100 disabled:opacity-50 disabled:pointer-events-none dark:bg-neutral-900 dark:border-neutral-700 dark:hover:bg-white/10 dark:text-white dark:hover:text-white dark:focus:text-white">
      <svg xmlns="http://www.w3.org/2000/svg" class="w-5 h-5" viewBox="0 0 640 480">
        <g fill-rule="evenodd">
          <path fill="#fff" d="M0 0h640v160H0z"/>
          <path fill="#0039a6" d="M0 160h640v160H0z"/>
          <path fill="#d52b1e" d="M0 320h640v160H0z"/>
    ...
    <!-- EN Button with Flag -->
    <button type="button" class="py-2 px-3 inline-flex items-center gap-x-2 text-sm font-medium text-nowrap rounded-xl border border-transparent bg-lime-400 text-black hover:bg-lime-500 focus:outline-hidden focus:bg-lime-500 transition disabled:opacity-50 disabled:pointer-events-none">
      <svg xmlns="http://www.w3.org/2000/svg" class="w-5 h-5" viewBox="0 0 60 30">
        <clipPath id="s">
          <path d="M0,0 v30 h60 v-30 z"/>
        </clipPath>
        <clipPath id="t">
    ...
    <div class="lg:hidden">
      ...
      <div id="hs-navbar-hcail" class="hs-collapse hidden overflow-hidden transition-all duration-300 basis-full grow lg:block lg:w-auto lg:basis-auto lg:order-2 lg:col-span-6" aria-labelledby="hs-navbar-hcail-collapse">
        <div class="flex flex-col gap-y-4 gap-x-0 mt-5 lg:flex-row lg:justify-center lg:items-center lg:gap-y-0 lg:gap-x-7 lg:mt-0">
          ...
          <div>
            <a class="inline-block text-black hover:text-gray-600 focus:outline-hidden focus:text-gray-600 dark:text-white dark:hover:text-neutral-300 dark:focus:text-neutral-300" href="#">О компании‍</a>
          </div>
          <div>
            <a class="inline-block text-black hover:text-gray-600 focus:outline-hidden focus:text-gray-600 dark:text-white dark:hover:text-neutral-300 dark:focus:text-neutral-300" href="#">Проекты‍</a>
          </div>
          <div>
            <a class="inline-block text-black hover:text-gray-600 focus:outline-hidden focus:text-gray-600 dark:text-white dark:hover:text-neutral-300 dark:focus:text-neutral-300" href="">Контакты</a>
          </div>
        </div>
      </div>
      <!-- End Collapse -->
    ...
    <div class="max-w-7xl px-4 sm:px-6 lg:px-8 py-12 lg:py-24 mx-auto">
      ...
      <div class=" grid grid-cols-1 sm:grid-cols-2 gap-8 lg:gap-12">
        ...
        <a class="group flex flex-col focus:outline-hidden" href="#">
          ...
          <div class="pt-4">
            <h3 class="relative inline-block font-medium text-lg text-black before:absolute before:bottom-0.5 before:start-0 before:-z-1 before:w-full before:h-1 before:bg-lime-400 before:transition before:origin-left before:scale-x-0 group-hover:before:scale-x-100 dark:text-white">
                Здание Центрального телеграфа находится на реставрации.
            </h3>
            {{-- <p class="mt-1 text-gray-600 dark:text-neutral-400">
              Moscow city
            </p> --}}
  ...
  <footer class="bg-gray-100 dark:bg-gray-900 text-black dark:text-white pt-10 pb-5 px-4 lg:px-20">
    <div class="grid grid-cols-1 md:grid-cols-4 gap-10">
      ...
      <div>
        ...
        <ul class="space-y-2">
          <li><a href="#" class="hover:underline">ПРОЕКТИРОВАНИЕ</a></li>
