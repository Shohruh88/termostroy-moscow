        ...
        <main id="content">
          ...
          "loadingClasses": "opacity-0"
            ...
            <section id="about" class="py-20 bg-white">
                <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    ...
                    <div class="grid lg:grid-cols-2 gap-12 items-center">
                        <div class="space-y-8" data-aos="fade-up-right">
                ...
                <div class="flex items-center animate-marquee">
                    ...
                    <div class="flex items-center justify-around">
                        <div class="px-4 w-40 md:w-64 h-12 flex shrink-0 justify-center items-center">
                            <a href="https://antyapi.ru/"><img class="" src="/images/ant-yapi-logo-2.png"
                                    alt=""></a>

                        </div>

                        <div class="px-4 w-40 md:w-64 h-12 flex shrink-0 justify-center items-center">
                            <a href="https://www.antteq.com/"><img class="" src="/images/ANTTEQ-logo.jpg"
                                    alt=""></a>
                        </div>

                        <div class="px-4 w-40 md:w-64 h-12 flex shrink-0 justify-center items-center">
                            <a href="https://www.capitalgroup.ru/ru"><img class="" src="/images/partner.jpeg"
                                    alt=""> </a>
                        </div>

                        <div class="px-4 w-40 md:w-64 h-12 flex shrink-0 justify-center items-center">
                            <a href="https://www.antteq.com/"><img class="" src="/images/AntTeq-logo1.png"
                                    alt=""> </a>
                        </div>

                        <div class="px-4 w-40 md:w-64 h-12 flex shrink-0 justify-center items-center">
                            <a href="https://www.antyapi.ru/"><img class="" src="/images/ant-yapi-logo-2.png"
                                    alt=""></a>
                            ...
                            <path d="M0 85.9997V45.6183L45.6184 0H85.9997V40.3814L40.3814 85.9997H0Z"
                                fill="currentColor" />
            ...
            <section id="services" class="py-20 bg-gray-100">
                <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div class="text-center mb-16" data-aos="fade-up-left">
                    ...
                    <div class="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
                        <!-- Service Card 1 -->
                        <div class="bg-white rounded-xl p-8 shadow-lg card-hover" data-aos="fade-up">
                            ...
                            <p class="text-gray-600 text-center">Проектирование всех видов инженерных систем жилых и
                                коммерческих зданий с учетом современных технологий</p>
                        </div>
                        ...
                        <div class="bg-white rounded-xl p-8 shadow-lg card-hover" data-aos="fade-up">
                            ...
                            <p class="text-gray-600 text-center">Выполнение строительно-монтажных работ в сфере инженерии в
                                соответствии с нормами безопасности</p>
                        </div>

                        <!-- Service Card 3 -->
                        <div class="bg-white rounded-xl p-8 shadow-lg card-hover" data-aos="fade-up">
                            <div
                                class="bg-purple-100 w-16 h-16 rounded-full flex items-center justify-center mb-6 mx-auto">
                                <i class="fas fa-cogs text-purple-600 text-2xl"></i>
                            </div>
                            <h3 class="text-xl font-bold text-gray-900 mb-4 text-center">Эксплуатация</h3>
                            <p class="text-gray-600 text-center">Техническая эксплуатация всех систем в объектах
                                недвижимости с обеспечением бесперебойной поддержки</p>
                        </div>

                        <!-- Service Card 4 -->
                        <div class="bg-white rounded-xl p-8 shadow-lg card-hover" data-aos="fade-up">
                            <div
                                class="bg-orange-100 w-16 h-16 rounded-full flex items-center justify-center mb-6 mx-auto">
                            ...
                            <p class="text-gray-600 text-center">Комплексное выполнение работ от проектирования до
                                эксплуатации с полной ответственностью</p>
                        </div>
                    </div>
                </div>
            </section>
                            ...
                            <div class="space-y-6">
                                ...
                                <div class="flex items-center space-x-4">
                                    ...
                                    <div>
                                        ...
                                        <a href="tel:+79672145669"
                                            class="opacity-90 hover:text-blue-300 transition-colors duration-300">+7 (967)
                                            214-56-69</a>
                                    </div>
                                </div>
                                ...
                                <div class="flex items-center space-x-4">
                                    ...
                                    <div>
                                        ...
                                        <a href="mailto:info@termostroy.moscow"
                                            class="opacity-90 hover:text-blue-300 transition-colors duration-300">info@termostroy.moscow</a>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="bg-white rounded-xl p-8 shadow-2xl">
                            ...
                            <form class="space-y-6">
                                ...
                                <div>
                                    ...
                                    <textarea rows="4"
                                        class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all duration-300"></textarea>
                                </div>
                                <button type="submit"
